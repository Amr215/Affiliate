...
{
    /// <summary>Webshare datacenter proxy settings. Picks a random proxy from <see cref="Proxies"/> per request.</summary>
    public class IspProxyOptions
    {
        ...
        /// <summary>Webshare proxy list, one entry per line as <c>host:port:username:password</c>.</summary>
